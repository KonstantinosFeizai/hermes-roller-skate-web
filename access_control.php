...
function restrict_access($required_roles, $redirect_page = 'index.php')
{
    ...
    if ($current_role === 'user') {
        ...
        // Skip profile check for API endpoints and specific pages
        $skip_pages = ['profile.php', 'onboarding.php', 'get_my_finance.php', 'get_my_classes.php', 'get_my_athletes.php'];
