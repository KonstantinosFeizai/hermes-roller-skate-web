...
$pageTitle = $pageTitle ?? 'Ακαδημία Roller Skate Ερμής';
$pageDesc = $pageDescription ?? 'Ακαδημία Roller Skate Ερμής - Μάθε, εξασκήσου και απόλαυσε το roller skating με την καθοδήγηση ειδικών.';
$pageKeywords = $pageKeywords ?? 'roller skating, μαθήματα πατινιών, Αθήνα, Hermes Rollerskate, μαθήματα rollers, ακαδημία rollers';
...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="nav-left">
            <a href="<?= asset('gr/index.php') ?>">
                <img src="<?= asset('photo/logo.webp') ?>" alt="Hermes Logo" class="nav-button" />
            </a>
        </div>

        <button class="hamburger" id="hamburger-button" aria-label="Εναλλαγή μενού πλοήγησης">
            <div class="bar"></div>
            <div class="bar"></div>
            <div class="bar"></div>
        </button>
        ...
        <ul class="nav-center">
            <li>
                <a href="<?= asset('gr/whoweare.php') ?>" class="nav-link<?= isActive($activePage, 'whoweare') ?>">
                    Ποιοι Είμαστε
                </a>
            </li>
            <li>
                <a href="<?= asset('gr/classes.php') ?>" class="nav-link<?= isActive($activePage, 'classes') ?>">
                    Μαθήματα
                </a>
            </li>
            <li>
                <a href="<?= asset('gr/activities.php') ?>" class="nav-link<?= isActive($activePage, 'activities') ?>">
                    Δραστηριότητες
                </a>
            </li>
            <li>
                <a href="<?= asset('gr/prices-policies.php') ?>"
                    class="nav-link<?= isActive($activePage, 'prices-policies') ?>">
                    Τιμές
                </a>
            </li>
            <li>
                <a href="<?= asset('gr/benefits.php') ?>" class="nav-link<?= isActive($activePage, 'benefits') ?>">
                    Οφέλη
                </a>
            </li>
        </ul>
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <div class="help-links">
            <h3 class="help-heading">Βοήθεια</h3>
            <a href="<?= asset('gr/policies.php#FAQ') ?>" class="nav-link">
                Συχνές Ερωτήσεις
            </a>
            <a href="<?= asset('gr/contact.php') ?>" class="nav-link">
                Επικοινωνία
            </a>
        </div>
    </div>
